...
export class UltimateGanttRenderer extends Component {
    ...
    <t t-else="">
        <t t-esc="t.successor_wbs || '-'"/>
                                     ...
                                     <div class="o_ug_sidebar_col opacity-75" t-attf-style="width: {{state.colWidths.mode}}px; position: relative;" t-on-dblclick="() => this.startCellEdit(t, 'scheduling_mode')">
                                     ...
                                     <div t-if="state.config.gantt_show_scheduling_direction" class="o_ug_sidebar_col opacity-75" t-attf-style="width: {{state.colWidths.scheduling_direction}}px; position: relative;" t-on-dblclick="() => this.startCellEdit(t, 'scheduling_direction')">
